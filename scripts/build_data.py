...
DOMAINS = [
    ("food",     ["eat", "drink", "rice", "noodle", "tea", "meat", "vegetabl", "fruit", "restaurant", "cook", "taste", "hungry", "meal", "dish", "beer", "coffee", "milk", "egg", "sugar", "salt", "snack", "breakfast", "lunch", "dinner", "soup", "bread", "wine", "food", "flavor", "spicy", "sweet", "sour", "bitter", "delicious", "delicacy"]),
    ("travel",   ["travel", "trip", "airport", "plane", "flight", "hotel", "ticket", "train", "tourist", "passport", "visa", "luggage", "map", "customs", "border", "tour", "journey", "vacation", "holiday", "sightseeing", "abroad", "foreign"]),
    ("transport",["car", "bus", "bike", "bicycle", "drive", "driver", "subway", "taxi", "ship", "boat", "ride", "walk", "road", "traffic", "vehicle", "sail", "row ", "helicopter", "motorcycle"]),
    ...
    ("people",   ["teacher", "student", "classmate", "colleague", "doctor", "nurse", "worker", "farmer", "police", "soldier", "manager", "waiter", "boss", "audience", "guest", "crowd", "everyone", "other people", "gentleman", "lady", "adult", "youth"]),
    ...
    ("places",   ["city", "country", "school", "hospital", "bank", "park", "street", "road", "home", "house", "apartment", "room", "office", "company", "cinema", "library", "store", "shop", "market", "supermarket", "restaurant", "bar ", "cafe", "square", "village", "town", "building", "floor", "address", "place", "location", "north", "south", "east", "west", "left", "right", "front", "back ", "beside", "near", "far"]),
    ("body",     ["body", "head", "hand", "foot", "eye", "ear", "nose", "mouth", "tooth", "hair", "face", "leg", "arm", "finger", "heart", "stomach", "skin", "blood", "bone", "brain", "sick", "ill", "medicine", "pain", "hurt", "injur", "health", "healthy", "fever", "cough", "tired", "hungry", "thirsty", "sleep", "wake", "dream", "rest", "breathe"]),
    ...
    ("work",     ["work", "job", "meeting", "company", "salary", "busy", "class", "study", "learn", "exam", "test", "homework", "university", "college", "major", "degree", "research", "science", "project", "plan", "report", "business", "trade", "market ", "economy", "industry", "career", "employ", "interview", "training", "skill", "experience"]),
    ("money",    ["buy", "sell", "price", "money", "cheap", "expensive", "pay", "shopping", "discount", "yuan", "cash", "credit card", "cost", "spend", "save", "expens", "wage", "income", "wealth", "poor", "rich", "bargain", "free "]),
    ("tech",     ["computer", "phone", "telephone", "internet", "email", "software", "website", "machine", "technology", "digital", "online", "network", "robot", "electronic", "battery", "screen", "keyboard", "data", "program"]),
...
DOMAIN_LABELS = {
    ...
    "family": "Family & Friends", "people": "People", "time": "Time & Dates",
    "numbers": "Numbers & Quantity", "places": "Places & Directions",
    "body": "Body & Health", "weather": "Weather", "nature": "Nature & Animals",
    "work": "Work & School", "money": "Shopping & Money", "tech": "Technology",
